...
export default function Home({ activeItem, screens }) {
  ...
  return (
    <div>
      {activeItem === '0' && <Menu_componente screens={screens} alingLists={alingLists} />}
      ...
      {activeItem === '3' && <Menu_Products_Approved screens={screens} items={20} alingLists={alingLists} />}
      {activeItem === '4' && <Menu_repayment screens={screens} items={20} alingLists={alingLists} />}
    </div>
  );
}
